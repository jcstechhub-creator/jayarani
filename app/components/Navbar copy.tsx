...
const navItems = [
  { label: "Home", path: "/" },
  {
    label: "Courses",
    children: [
      { label: "B.A. (English)", path: "/allcourse/ba-english" },
      { label: "B.Com (Commerce)", path: "/allcourse/bcom" },
      { label: "B.Com CA (Computer Applications)", path: "/allcourse/bcom-ca" },
      { label: "B.Sc (Maths)", path: "/allcourse/bsc-maths" },
      { label: "B.Sc (Computer Science)", path: "/allcourse/bsc-cs" },
      { label: "B.Sc CS AI & DS", path: "/allcourse/bsc-ai-ds" },
    ],
  },
  {
    label: "Innovation",
