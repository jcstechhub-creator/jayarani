...
import HeroCarousel from "../components/HeroCarousel copy";

  const courses = [
    {
      name: "B.A. (English)",
      path: "/allcourse/ba-english",
